...
public class ApiDocConfigure {
    ...
    public Docket createSysRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("sys")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tuoshecx.server.cms.api.sys"))
    ...
    public Docket createManageRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("manage")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tuoshecx.server.cms.api.manage"))
                .paths(PathSelectors.any())
                .build();
    }
    ...
    public Docket createClientRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("client")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tuoshecx.server.cms.api.client"))
                .paths(PathSelectors.any())
                .build();
    }
    ...
    public Docket createCommonRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("common")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tuoshecx.server.cms.api.common"))
                .paths(PathSelectors.any())
                .build();
    }
}