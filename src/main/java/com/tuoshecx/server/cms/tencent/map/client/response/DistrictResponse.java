package com.tuoshecx.server.cms.tencent.map.client.response;
...
public class DistrictResponse extends QqMapResponse {
    ...
    public DistrictResponse(Map<String, Object> map){
        ...
        this.districts = result.stream().flatMap(List::stream).map(District::new).collect(Collectors.toList());
    }
