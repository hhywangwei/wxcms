...
import com.tuoshecx.server.wx.component.client.request.UpdateDomainRequest;
 ...
 */
class UpdateDomainClient extends WxComponentClient<UpdateDomainRequest, ComponentResponse> {
