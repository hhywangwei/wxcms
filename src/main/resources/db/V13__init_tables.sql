...
CREATE TABLE IF NOT EXISTS que_project (
  ...
  que_info_id VARCHAR(32) COLLATE utf8_bin NOT NULL '问卷调查表编号id',
  type VARCHAR(50) COLLATE utf8_bin NOT NULL '项目类型',
  create_user VARCHAR(100) COLLATE utf8_bin DEFAULT '' NOT NULL '创建用户',
  update_user VARCHAR(100) COLLATE utf8_bin DEFAULT '' NOT NULL '修改用户',
...
CREATE TABLE IF NOT EXISTS que_info(
  ...
  organ_id VARCHAR(32) COLLATE utf8_bin NOT NULL '组织机构编号',
...
CREATE TABLE IF NOT EXISTS que_answer(
  ...
  que_info_id VARCHAR(32) COLLATE utf8_bin NOT NULL '问卷调查表编号id',
  organ_id VARCHAR(32) COLLATE utf8_bin NOT NULL '组织机构编号',
  answer_time VARCHAR(50) COLLATE utf8_bin NOT NULL '答题用时',
  answer VARCHAR(1000) COLLATE utf8_bin NOT NULL COMMENT '用户提交答案',
  create_time DATETIME NOT NULL COMMENT '创建时间',
  is_delete TINYINT DEFAULT 0 NOT NULL COMMENT '是否删除',
  PRIMARY KEY (id),
  UNIQUE KEY uniq_user_id (user_id),
  UNIQUE KEY uniq_que_id (que_id),
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;